...
import org.xepelin_bank.mono_log.adapter.config.MonoLogConfig
import org.xepelin_bank.mono_log.adapter.config.MonoLogConfigEnv

abstract class AbstractModule(private val vertx: Vertx) : AbstractModule() {

    private val config: MonoLogConfig = MonoLogConfigEnv()
